    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                ...
                <h5 class="font-bold text-center text-black">New Transaction</h5><br>                
                <form action="{{ route('transactions.store') }}" method="POST">
                    @csrf
                    <div>
                        <label for="date">Select Transaction Date</label><br>
                        <input type="date" name="date" class="block w-96 appearance-none rounded-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm" placeholder="transaction date" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="note" class="block w-96 appearance-none rounded-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm" placeholder="enter note" required>
                    </div>
